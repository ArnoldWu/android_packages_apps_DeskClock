...
package com.autils.deskclock.provider;
...
public final class AlarmInstance implements ClockContract.InstancesColumns {
    ...
    public String getLabelOrDefault(Context context) {
        return mLabel.isEmpty() ? context.getString(com.autils.deskclock.R.string.default_label) : mLabel;
    }
    ...
    public Calendar getTimeout(Context context) {
        ...
        if (timeoutSetting == null) {
            timeoutSetting = context.getResources()
                    .getString(com.autils.deskclock.R.string.default_auto_silence_value);
        }
