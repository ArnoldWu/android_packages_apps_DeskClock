...
package com.autils.deskclock.worldclock;
...
import com.autils.deskclock.SettingsActivity;
import com.autils.deskclock.Utils;
import com.autils.deskclock.worldclock.db.DbCities;
import com.autils.deskclock.worldclock.db.DbCity;
...
public class CitiesActivity extends Activity implements OnCheckedChangeListener,
    ...
    private class SearchActionExpandListener implements OnActionExpandListener {
        ...
        public boolean onMenuItemActionExpand(MenuItem item) {
            MenuItem menuItem = mMenu.findItem(com.autils.deskclock.R.id.menu_item_add);
            if (menuItem != null) {
    ...
    private class CityAdapter extends BaseAdapter implements Filterable, SectionIndexer {
        ...
        public CityAdapter(
            ...
            mNormalCityFgColor = res.getColor(com.autils.deskclock.R.color.clock_white);
            // mUserDefinedCityFgColor = res.getColor(R.color.red);
            mUserDefinedCityFgColor = res.getColor(com.autils.deskclock.R.color.clock_gray);
        ...
        public synchronized View getView(int position, View view, ViewGroup parent) {
            ...
            if (c.mCityId == null) {
                if (view == null) {
                    view = mInflater.inflate(com.autils.deskclock.R.layout.city_list_header, parent, false);
                }
            } else { // City view
                // Make sure to recycle a City view only
                if (view == null) {
                    view = mInflater.inflate(com.autils.deskclock.R.layout.city_list_item, parent, false);
                    final CityViewHolder holder = new CityViewHolder();
                    holder.index = (TextView) view.findViewById(com.autils.deskclock.R.id.index);
                    holder.name = (TextView) view.findViewById(com.autils.deskclock.R.id.city_name);
                    holder.time = (TextView) view.findViewById(com.autils.deskclock.R.id.city_time);
                    holder.selected = (CheckBox) view.findViewById(com.autils.deskclock.R.id.city_onoff);
                    view.setTag(holder);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedCitiesHeaderString = getString(com.autils.deskclock.R.string.selected_cities_label);
    ...
    private void updateLayout() {
        setContentView(com.autils.deskclock.R.layout.cities_activity);
        mCitiesList = (ListView) findViewById(com.autils.deskclock.R.id.cities_list);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                finish();
                break;
            case com.autils.deskclock.R.id.menu_item_add:
                showAddCityDialog(null);
                return true;
            case com.autils.deskclock.R.id.menu_item_settings:
                startActivity(new Intent(this, SettingsActivity.class));
                return true;
            case com.autils.deskclock.R.id.menu_item_help:
                ...
                return true;
            case com.autils.deskclock.R.id.menu_item_sort:
                if (mAdapter != null) {
                    mAdapter.toggleSort();
                    setFastScroll(TextUtils.isEmpty(mQueryTextBuffer.toString().trim()));
                }
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        getMenuInflater().inflate(com.autils.deskclock.R.menu.cities_menu, menu);

        MenuItem search = menu.findItem(com.autils.deskclock.R.id.menu_item_search);
        if (search != null) {
            search.setOnActionExpandListener(new SearchActionExpandListener(menu));
        }

        MenuItem help = menu.findItem(com.autils.deskclock.R.id.menu_item_help);
        if (help != null) {
            Utils.prepareHelpMenuItem(this, help);
        }

        MenuItem searchMenu = menu.findItem(com.autils.deskclock.R.id.menu_item_search);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        MenuItem sortMenuItem = menu.findItem(com.autils.deskclock.R.id.menu_item_sort);
        if (mSortType == SORT_BY_NAME) {
            sortMenuItem.setTitle(getString(com.autils.deskclock.R.string.menu_item_sort_by_gmt_offset));
        } else {
            sortMenuItem.setTitle(getString(com.autils.deskclock.R.string.menu_item_sort_by_name));
        }
    ...
    public void onClick(View v) {
        CompoundButton b = (CompoundButton) v.findViewById(com.autils.deskclock.R.id.city_onoff);
    ...
    public void onCitySelected(String name, String tz) {
        ...
        if (city != null) {
            ...
            Toast.makeText(this, com.autils.deskclock.R.string.cities_add_already_exists,
        ...
        if (id < 0) {
          ...
          Toast.makeText(this, com.autils.deskclock.R.string.cities_add_city_failed,
                  Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void deleteCity(final CityObj c) {
        ...
        builder.setTitle(com.autils.deskclock.R.string.cities_delete_city_title);
        builder.setMessage(getString(com.autils.deskclock.R.string.cities_delete_city_msg, c.mCityName));
        builder.setPositiveButton(getString(android.R.string.ok),
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (DbCities.deleteCity(CitiesActivity.this, id) > 0) {
                    ...
                    // Something went wrong
                    Toast.makeText(CitiesActivity.this, com.autils.deskclock.R.string.cities_delete_city_failed,
                            Toast.LENGTH_SHORT).show();
                }
            }
        });
