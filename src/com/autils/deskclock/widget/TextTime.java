...
package com.autils.deskclock.widget;
...
public class TextTime extends TextView {
    ...
    public TextTime(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray styledAttributes = context.obtainStyledAttributes(
                attrs, com.autils.deskclock.R.styleable.TextTime, defStyle, 0);
        try {
            mFormat12 = styledAttributes.getText(com.autils.deskclock.R.styleable.TextTime_format12Hour);
            mFormat24 = styledAttributes.getText(com.autils.deskclock.R.styleable.TextTime_format24Hour);
        } finally {
